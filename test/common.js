  ...
  describe('kibana link generator', () => {
    it('should make links when msgName is not auto', () => {
      ...
      assert.equal(link, 'https://logs.twiket.com/app/kibana#/discover?_g=(refreshInterval:(display:Off,pause:!f,value:0),'
        ...
        + 'params:(query:monitorDirectFlights,type:phrase),type:phrase,value:monitorDirectFlights),'
        + 'query:(match:(msgName:(query:monitorDirectFlights,type:phrase)))),'
        + '(\'$state\':(store:appState),meta:(alias:!n,disabled:!f,index:\'twapi-avia-*\',key:fields.name,negate:!f,'
        + 'params:(query:SEARCH_MONITORING,type:phrase),type:phrase,value:SEARCH_MONITORING),'
        + 'query:(match:(fields.name:(query:SEARCH_MONITORING,type:phrase))))),'
        + 'index:\'twapi-avia-*\',interval:auto,query:(language:lucene,query:\'\'),sort:!(\'@timestamp\',desc))');
    });
    it('should make links when msgName is auto', () => {
      ...
      assert.equal(link, 'https://logs.twiket.com/app/kibana#/discover?_g=(refreshInterval:(display:Off,pause:!f,value:0),'
        + 'time:(from:now-1h,mode:quick,to:now))&_a=(columns:!(message),filters:!((\'$state\':(store:appState),'
        + 'meta:(alias:!n,disabled:!f,index:\'twapi-avia-*\',key:fields.name,negate:!f,'
        + 'params:(query:SEARCH_MONITORING,type:phrase),type:phrase,value:SEARCH_MONITORING),'
        + 'query:(match:(fields.name:(query:SEARCH_MONITORING,type:phrase))))),index:\'twapi-avia-*\','
